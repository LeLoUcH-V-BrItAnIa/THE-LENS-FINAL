...
<div class="header">
    <div class="container1">
        ...
        <div class="row">
            <div class="col">
                <img src="female_models_afterloginpage\ileana d'cruz\1.png" height="650px" width="500px"></div>
                <div class="col">
                <h1>
                            ILEANA D'CRUZ
                </h1>
                <p>Name:Ileanad d'cruz<br>Email:Ileanad'cruz@gmail.com<br>Age:26year old<br>Experince:WON "Model of the year"<br>Height: 123cm<br>Waist:64cm <br>Chest:84cm <br>Hips:81cm <br>Shoes:21.1<br>Hair:Dark Brown <br>Shirt:XL<br>PH No:6448799923</p>
...
<div class="row1">
 <div class="container">
    ...
    <div class="photo-gallery">
        ...
        <div class="pic">
           <a href=""><img src="female_models_afterloginpage\ileana d'cruz\2.png"></a>
        </div>
        <div class="pic1">
            <a href=""><img src="female_models_afterloginpage\ileana d'cruz\3.png" alt=""></a>
        </div>
        <div class="pic2">
            <a href=""><img src="female_models_afterloginpage\ileana d'cruz\4.png" alt=""></a>
        </div>
        <div class="pic3">
            <a href=""><img src="female_models_afterloginpage\ileana d'cruz\5.png" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="female_models_afterloginpage\ileana d'cruz\6.png" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="female_models_afterloginpage\ileana d'cruz\1.png"></a>
        </div>
    </div>
</div>
 <script>
