...
<div class="header">
    <div class="container1">
        ...
        <div class="row">
            <div class="col">
                <img src="female_photographer\ketaki_sheth\7.png" height="650px" width="500px"></div>
                <div class="col">
                <h1>
                           KETAKI SHETH
                </h1>
                <p>Name:Ketaki Sheth<br>Age:25year old<br>Email:Ketakisheth365@gmail.com<br>Experience:Editorial Photography <br>Gender:Female<br> Location:Kolkata<br>Password:Ketaki@765<br>Genre:Time-lapes photography <br>Camera:Canon EOS 80D<br>Social Media:Steller Stories</p>
...
<div class="row1">
 <div class="container">
    ...
    <div class="photo-gallery">
        ...
        <div class="pic">
           <a href=""><img src="female_photographer\ketaki_sheth\Ketaki Sheth1.jpg"></a>
        </div>
        <div class="pic1">
            <a href=""><img src="female_photographer\ketaki_sheth\Ketaki Sheth2.jpg" alt=""></a>
        </div>
        <div class="pic2">
            <a href=""><img src="female_photographer\ketaki_sheth\Ketaki Sheth3.jpg" alt=""></a>
        </div>
        <div class="pic3">
            <a href=""><img src="female_photographer\ketaki_sheth\Ketaki Sheth4.jpg" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="female_photographer\ketaki_sheth\Ketaki Sheth5.jpg" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="female_photographer\ketaki_sheth\Ketaki Sheth6.jpg"></a>
        </div>
    </div>
</div>
 <script>
