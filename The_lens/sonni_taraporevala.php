...
<div class="header">
    <div class="container1">
        ...
        <div class="row">
            <div class="col">
                <img src="female_photographer\Sooni Taraporevala\7.png" height="650px" width="500px"></div>
                <div class="col">
                <h1>
                            SONNI TARAPOREVALA
                </h1>
                <p>Name:Sonni Taraporevala<br>Age:31year old<br>Email:TAraporevala47@gmail.com<br>Experience:potrait photographer<br>Gender:Male<br> Location:Delhi<br>Password:Sonni@657<br>Genre:Fashoin photography <br>Camera:Canon X<br>Social Media:Flickr</p>  
...
<div class="row1">
 <div class="container">
    ...
    <div class="photo-gallery">
        ...
        <div class="pic">
           <a href=""><img src="female_photographer\Sooni Taraporevala\Sooni Taraporevala1.jpg"></a>
        </div>
        <div class="pic1">
            <a href=""><img src="female_photographer\Sooni Taraporevala\Sooni Taraporevala2.jpg" alt=""></a>
        </div>
        <div class="pic2">
            <a href=""><img src="female_photographer\Sooni Taraporevala\Sooni Taraporevala3.jpg" alt=""></a>
        </div>
        <div class="pic3">
            <a href=""><img src="female_photographer\Sooni Taraporevala\Sooni Taraporevala4.jpg" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="female_photographer\Sooni Taraporevala\Sooni Taraporevala5.jpg" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="female_photographer\Sooni Taraporevala\Sooni Taraporevala6.jpg"></a>
        </div>
    </div>
</div>
 <script>
