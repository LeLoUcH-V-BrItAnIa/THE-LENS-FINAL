...
<div class="header">
    <div class="container1">
        ...
        <div class="row">
            <div class="col">
                <img src="female_models_afterloginpage\shibani dhandekar\1.png" height="650px" width="500px"></div>
                <div class="col">
                <h1>
                            SHIBANI DHANDEKAR
                </h1>
                <p>Name:Shibani Dhandekar<br>Email:SHibani789@gmail.com<br>Age:35year old<br>Experince:REd model Management<br>Height: 123cm<br>Waist:79cm <br>Chest:75cm <br>Hips:83cm <br>Shoes:20.9<br>Hair:Darkest Brown <br>Shirt:XL<br>PH No:6478964521</p>
...
<div class="row1">
 <div class="container">
    ...
    <div class="photo-gallery">
        ...
        <div class="pic">
           <a href=""><img src="female_models_afterloginpage\shibani dhandekar\1.png"></a>
        </div>
        <div class="pic1">
            <a href=""><img src="female_models_afterloginpage\shibani dhandekar\2.png" alt=""></a>
        </div>
        <div class="pic2">
            <a href=""><img src="female_models_afterloginpage\shibani dhandekar\3.png" alt=""></a>
        </div>
        <div class="pic3">
            <a href=""><img src="female_models_afterloginpage\shibani dhandekar\4.png" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="female_models_afterloginpage\shibani dhandekar\5.png" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="female_models_afterloginpage\shibani dhandekar\6.png"></a>
        </div>
    </div>
</div>
 <script>
