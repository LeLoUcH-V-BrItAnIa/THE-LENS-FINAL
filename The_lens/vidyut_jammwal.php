...
<div class="header">
    <div class="container1">
        ...
        <div class="row">
            <div class="col">
                <img src="male_model_afterlogin\vidyut jamal\2.png" height="650px" width="500px"></div>
                <div class="col">
                <h1>
                            VIDYUT JAMMWAL
                </h1>
                <p>Name: Vidyut Jammwal<br>Email: Vidyut436@gmail.com<br>Age:32year old<br>Experience:Team lead<br>Location:Africa<br>Password:Vidyut@568<br>Gender:Male<br>Height: 123cm<br>Waist:27cm<br>Chest:40cm <br>Hips: 78cm<br>Shoes: 23.7cm <br>Hair:brown <br>Shirt: XL<br>PH No:2459783269</p>
...
<div class="row1">
 <div class="container">
    ...
    <div class="photo-gallery">
        ...
        <div class="pic">
           <a href=""><img src="male_model_afterlogin\vidyut jamal\1.png"></a>
        </div>
        <div class="pic1">
            <a href=""><img src="male_model_afterlogin\vidyut jamal\2.png" alt=""></a>
        </div>
        <div class="pic2">
            <a href=""><img src="male_model_afterlogin\vidyut jamal\3.png" alt=""></a>
        </div>
        <div class="pic3">
            <a href=""><img src="male_model_afterlogin\vidyut jamal\4.png" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="male_model_afterlogin\vidyut jamal\5.png" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="male_model_afterlogin\vidyut jamal\6.png"></a>
        </div>
    </div>
</div>
 <script>
