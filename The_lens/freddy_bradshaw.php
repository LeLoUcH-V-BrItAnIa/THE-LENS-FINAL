...
<div class="header">
    <div class="container1">
        ...
        <div class="row">
            <div class="col">
                <img src="male_model_afterlogin\freddy\2.png" height="650px" width="500px"></div>
                <div class="col">
                <h1>
                            FREDDY BRADSHAW
                </h1>
                <p>Name:Freddy Bradshaw<br>Email:Freddybradshaw354@gmail.com<br>Age:27year old<br>Experince:Idol looks modeling<br>Height: 123cm<br>Waist:88cm <br>Chest:94cm <br>Hips:86cm <br>Shoes:22.9<br>Hair:Brown <br>Shirt:X6L<br>PH No:54698763266</p>
...
<div class="row1">
 <div class="container">
    ...
    <div class="photo-gallery">
        ...
        <div class="pic">
           <a href=""><img src="male_model_afterlogin\freddy\1.png"></a>
        </div>
        <div class="pic1">
            <a href=""><img src="male_model_afterlogin\freddy\2.png" alt=""></a>
        </div>
        <div class="pic2">
            <a href=""><img src="male_model_afterlogin\freddy\3.png" alt=""></a>
        </div>
        <div class="pic3">
            <a href=""><img src="male_model_afterlogin\freddy\4.png" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="male_model_afterlogin\freddy\5.png" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="male_model_afterlogin\freddy\6.png"></a>
        </div>
    </div>
</div>
 <script>
