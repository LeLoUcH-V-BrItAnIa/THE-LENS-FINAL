...
<div class="header">
    <div class="container1">
        ...
        <div class="row">
            <div class="col">
                <img src="male_photographers\7.png" height="650px" width="500px"></div>
                <div class="col">
                <h1>
                    SUDHIR SIVARAM
                </h1>
                <p>Name:Sudhir<br>Age:35year old<br>Email:Sudhir573@gmail.com<br>Experience:Legislatuer Photography <br>Gender:Male<br> Location:Delhi<br>Password:Sudhir@657<br>Genre:Composition photography <br>Camera:Canon R5<br>Social Media:Facebook</p>  
...
<div class="row1">
 <div class="container">
    ...
    <div class="photo-gallery">
        ...
        <div class="pic">
           <a href=""><img src="male_photographers\sudhir sivaram\Sudhir Shivaram1.jpg"></a>
        </div>
        <div class="pic1">
            <a href=""><img src="male_photographers\sudhir sivaram\Sudhir Shivaram2.jpg" alt=""></a>
        </div>
        <div class="pic2">
            <a href=""><img src="male_photographers\sudhir sivaram\Sudhir Shivaram3.jpg" alt=""></a>
        </div>
        <div class="pic3">
            <a href=""><img src="male_photographers\sudhir sivaram\Sudhir Shivaram4.jpg" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="male_photographers\sudhir sivaram\Sudhir Shivaram5.jpg" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="male_photographers\sudhir sivaram\Sudhir Shivaram6.jpg"></a>
        </div>
    </div>
</div>
    ...
    <div class="container1">
        <div class="row10">
            <div class="footer-col-1">
                <div class="app-logo">
                    <img src="C:\xampp\htdocs\onlinereg prototype_1\LOGO3.png">
