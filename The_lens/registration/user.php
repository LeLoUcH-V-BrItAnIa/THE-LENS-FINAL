        ...
        <body>
            <div id="container_1">
              ...
              <div id="container_2">
                ...
                <form id="survey-form" action="userreg.php" method="POST" enctype="multipart/form-data">
                  ...
                  <label id="number-label">number</label>
                    <input type="tel" id="number" name="number" class="form" placeholder="phone number" pattern="[0-9][0-9]{9}" required><br><!---number-->
