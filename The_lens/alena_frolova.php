...
<div class="header">
    <div class="container1">
        ...
        <div class="row">
            <div class="col">
                <img src="female_models_afterloginpage\alena frolova\1.png" height="650px" width="500px"></div>
                <div class="col">
                <h1>
                            ALENA FROLOVA
                </h1>
                <p> Name:Alena Frolova<br>Email:Alenafrolova13@gmail.com<br>Age:25year old<br>Experince:Freelance Modeling<br>Height: 123cm<br>Waist:64cm <br>Chest:40cm <br>Hips:86cm <br>Shoes:20.4cm <br>Hair:black <br>Shirt:L <br>PH No:4587624937</p>
...
<div class="row1">
 <div class="container">
    ...
    <div class="photo-gallery">
        ...
        <div class="pic">
           <a href=""><img src="female_models_afterloginpage\alena frolova\1.png"></a>
        </div>
        <div class="pic1">
            <a href=""><img src="female_models_afterloginpage\alena frolova\2.png" alt=""></a>
        </div>
        <div class="pic2">
            <a href=""><img src="female_models_afterloginpage\alena frolova\3.png" alt=""></a>
        </div>
        <div class="pic3">
            <a href=""><img src="female_models_afterloginpage\alena frolova\4.png" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="female_models_afterloginpage\alena frolova\5.png" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="female_models_afterloginpage\alena frolova\6.png"></a>
        </div>
    </div>
</div>
 <script>
