...
<div class="header">
    <div class="container1">
        ...
        <div class="row">
            <div class="col">
                <img src="male_model_afterlogin\david guello\1.png" height="650px" width="500px"></div>
                <div class="col">
                <h1>
                            DAVID GUELLO
                </h1>
                <p> Name:David Guello<br>Email:Davidguello254@gmail.com<br>Age:30year old<br>Experince:Lincoln Talent Agency<br>Height: 123cm<br>Waist:79cm <br>Chest:94cm <br>Hips:86cm <br>Shoes:25.4cm <br>Hair:black <br>Shirt:XXL <br>PH No:1245879635</p>
...
<div class="row1">
 <div class="container">
    ...
    <div class="photo-gallery">
        ...
        <div class="pic">
           <a href=""><img src="male_model_afterlogin\david guello\1.png"></a>
        </div>
        <div class="pic1">
            <a href=""><img src="male_model_afterlogin\david guello\2.png" alt=""></a>
        </div>
        <div class="pic2">
            <a href=""><img src="male_model_afterlogin\david guello\3.png" alt=""></a>
        </div>
        <div class="pic3">
            <a href=""><img src="male_model_afterlogin\david guello\4.png" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="male_model_afterlogin\david guello\5.png" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="male_model_afterlogin\david guello\6.png"></a>
        </div>
    </div>
</div>
 <script>
