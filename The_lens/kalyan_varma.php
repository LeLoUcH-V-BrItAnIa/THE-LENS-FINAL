...
<div class="header">
    <div class="container1">
        ...
        <div class="row">
            <div class="col">
                <img src="male_photographers\2.png" height="650px" width="500px"></div>
                <div class="col">
                <h1>
                            KALYAN VARMA
                </h1>
                <p>Name:Klayan Varma<br>Age:26year old<br>Email:Klayanvarma365@gmail.com<br>Experience:film Photography <br>Gender:Male<br> Location:Kolkata<br>Password:Kalyan@123<br>Genre:Fashion photography <br>Camera:NikonD5600<br>Social Media:Plates</p>  
...
<div class="row1">
 <div class="container">
    ...
    <div class="photo-gallery">
        ...
        <div class="pic">
           <a href=""><img src="male_photographers\kalyan varma\Kalyan varma1.jpg"></a>
        </div>
        <div class="pic1">
            <a href=""><img src="male_photographers\kalyan varma\Kalyan varma2.jpg" alt=""></a>
        </div>
        <div class="pic2">
            <a href=""><img src="male_photographers\kalyan varma\Kalyan varma3.jpg" alt=""></a>
        </div>
        <div class="pic3">
            <a href=""><img src="male_photographers\kalyan varma\Kalyan varma4.jpg" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="male_photographers\kalyan varma\Kalyan varma5.jpg" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="male_photographers\kalyan varma\Kalyan varma6.jpg"></a>
        </div>
    </div>
</div>
 <script>
