...
<div class="header">
    <div class="container1">
        ...
        <div class="row">
            <div class="col">
                <img src="female_models_afterloginpage\zoya afroz\3.png" height="650px" width="500px"></div>
                <div class="col">
                <h1>
                           ZOYA AFROZ
                </h1>
                <p>Name:Zoya Afroz<br>Email: Zoya1234@gmail.com<br>Age:34 year old<br>Experience:Emerging talent<br> PAssword:ZOYA@143<br>Location:Canada<br>Gender:Female<br>Height: 123cm<br>Waist:46cm <br>Chest:35cm <br>Hips:14cm <br>Shoes:6cm <br>Hair: 17mm<br>Shirt:XL/,br>PH No:2145789654</p>
...
<div class="row1">
 <div class="container">
    ...
    <div class="photo-gallery">
        ...
        <div class="pic">
           <a href=""><img src="female_models_afterloginpage\zoya afroz\1.png"></a>
        </div>
        <div class="pic1">
            <a href=""><img src="female_models_afterloginpage\zoya afroz\4.png" alt=""></a>
        </div>
        <div class="pic2">
            <a href=""><img src="female_models_afterloginpage\zoya afroz\3.png" alt=""></a>
        </div>
        <div class="pic3">
            <a href=""><img src="female_models_afterloginpage\zoya afroz\2.png" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="female_models_afterloginpage\zoya afroz\5.png" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="female_models_afterloginpage\zoya afroz\6.png"></a>
        </div>
    </div>
</div>
 <script>
