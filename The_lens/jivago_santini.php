...
<div class="header">
    <div class="container1">
        ...
        <div class="row">
            <div class="col">
                <img src="male_model_afterlogin\jivago\4.png" height="650px" width="500px"></div>
                <div class="col">
                <h1>
                            JIVAGO SANTINI
                </h1>
                <p>Name:Jivago Santini<br>Email:JivagoSantini684@gmail.com<br>Age:32year old<br>ExperinModel ACE Talent<br>Height: 123cm<br>Waist:92cm <br>Chest:99cm <br>Hips:87cm <br>Shoes:23.9<br>Hair:Blonde <br>Shirt:XXL<br>PH No:1359476817</p>
...
<div class="row1">
 <div class="container">
    ...
    <div class="photo-gallery">
        ...
        <div class="pic">
           <a href=""><img src="male_model_afterlogin\jivago\1.png"></a>
        </div>
        <div class="pic1">
            <a href=""><img src="male_model_afterlogin\jivago\2.png" alt=""></a>
        </div>
        <div class="pic2">
            <a href=""><img src="male_model_afterlogin\jivago\3.png" alt=""></a>
        </div>
        <div class="pic3">
            <a href=""><img src="male_model_afterlogin\jivago\4.png" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="male_model_afterlogin\jivago\5.png" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="male_model_afterlogin\jivago\6.png"></a>
        </div>
    </div>
</div>
 <script>
