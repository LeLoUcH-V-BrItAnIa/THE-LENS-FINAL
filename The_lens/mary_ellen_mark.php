...
<div class="header">
    <div class="container1">
        ...
        <div class="row">
            <div class="col">
                <img src="female_photographer\Mary Ellen Mark\7.png" height="650px" width="500px"></div>
                <div class="col">
                <h1>
                            MARY ELLEN MARK
                </h1>
                <p>Name:Mary-ellen-Mark<br>Age:27year old<br>Email:mary536@gmail.com<br>Experience: Portraits <br>Gender:Female<br> Location:Norway<br>Password:Mary@657<br>Genre:Fashoin photography <br>Camera:NikonD5600<br>Social Media:Plates</p>
...
<div class="row1">
 <div class="container">
    ...
    <div class="photo-gallery">
        ...
        <div class="pic">
           <a href=""><img src="female_photographer\Mary Ellen Mark\Mary Ellen Mark1.jpg"></a>
        </div>
        <div class="pic1">
            <a href=""><img src="female_photographer\Mary Ellen Mark\Mary Ellen Mark2.jpg" alt=""></a>
        </div>
        <div class="pic2">
            <a href=""><img src="female_photographer\Mary Ellen Mark\Mary Ellen Mark3.jpg" alt=""></a>
        </div>
        <div class="pic3">
            <a href=""><img src="female_photographer\Mary Ellen Mark\Mary Ellen Mark4.jpg" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="female_photographer\Mary Ellen Mark\Mary Ellen Mark5.jpg" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="female_photographer\Mary Ellen Mark\Mary Ellen Mark6.jpg"></a>
        </div>
    </div>
</div>
 <script>
