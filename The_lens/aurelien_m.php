...
<div class="header">
    <div class="container1">
        ...
        <div class="row">
            <div class="col">
                <img src="male_model_afterlogin\arrulian m\1.png" height="650px" width="500px"></div>
                <div class="col">
                <h1>
                            AURELIEN M
                </h1>
                <p>Name:Aurelien M<br>Email:Aurelienm56@gmail.com<br>Age:25year old<br>Experince:REd model Management<br>Height: 123cm<br>Waist:79cm <br>Chest:91cm <br>Hips:82cm <br>Shoes:22.9<br>Hair:Brown <br>Shirt:XL<br>PH No:1359476817</p>
...
<div class="row1">
 <div class="container">
    ...
    <div class="photo-gallery">
        ...
        <div class="pic">
           <a href=""><img src="male_model_afterlogin\arrulian m\1.png"></a>
        </div>
        <div class="pic1">
            <a href=""><img src="male_model_afterlogin\arrulian m\2.png" alt=""></a>
        </div>
        <div class="pic2">
            <a href=""><img src="male_model_afterlogin\arrulian m\3.png" alt=""></a>
        </div>
        <div class="pic3">
            <a href=""><img src="male_model_afterlogin\arrulian m\4.png" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="male_model_afterlogin\arrulian m\5.png" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="male_model_afterlogin\arrulian m\6.png"></a>
        </div>
    </div>
</div>
