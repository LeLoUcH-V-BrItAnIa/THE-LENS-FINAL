...
<div class="header">
    <div class="container1">
        ...
        <div class="row">
            <div class="col">
                <img src="female_models_afterloginpage\Erika Packard\6.png" height="650px" width="500px"></div>
                <div class="col">
                <h1>
                            ERIKA PACKARD
                </h1>
                <p>Name:Erika Packard<br>Email:Erika653@gmail.com<br>Age:28year old<br>Experince:Majoring in art & performance<br>Height: 123cm<br>Waist:81cm <br>Chest:96cm <br>Hips:80cm <br>Shoes:21.5<br>Hair:Black <br>Shirt:XL<br>PH No:3546987251</p>
...
<div class="row1">
 <div class="container">
    ...
    <div class="photo-gallery">
        ...
        <div class="pic">
           <a href=""><img src="female_models_afterloginpage\Erika Packard\1.png"></a>
        </div>
        <div class="pic1">
            <a href=""><img src="female_models_afterloginpage\Erika Packard\2.png" alt=""></a>
        </div>
        <div class="pic2">
            <a href=""><img src="female_models_afterloginpage\Erika Packard\3.png" alt=""></a>
        </div>
        <div class="pic3">
            <a href=""><img src="female_models_afterloginpage\Erika Packard\4.png" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="female_models_afterloginpage\Erika Packard\5.png" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="female_models_afterloginpage\Erika Packard\6.png"></a>
        </div>
    </div>
</div>
 <script>
