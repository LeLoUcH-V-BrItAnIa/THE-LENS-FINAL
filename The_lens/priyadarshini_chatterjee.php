...
<div class="header">
    <div class="container1">
        ...
        <div class="row">
            <div class="col">
                <img src="female_models_afterloginpage\priyadarshini\4.png" height="650px" width="500px"></div>
                <div class="col">
                <h1>
                            PRIYADARSHINI CHATTERJEE
                </h1>
                <p>Name:Priyadarshini Chatterjee<br>Email:Priyadarshini548@gmail.com<br>Age:24year old<br>Experince:REd model Management<br>Height: 123cm<br>Waist:79cm <br>Chest:75cm <br>Hips:83cm <br>Shoes:20.9<br>Hair:Darkest Brown <br>Shirt:XL<br>PH No:3548976219</p>
...
<div class="row1">
 <div class="container">
    ...
    <div class="photo-gallery">
        ...
        <div class="pic">
           <a href=""><img src="female_models_afterloginpage\priyadarshini\1.png"></a>
        </div>
        <div class="pic1">
            <a href=""><img src="female_models_afterloginpage\priyadarshini\2.png" alt=""></a>
        </div>
        <div class="pic2">
            <a href=""><img src="female_models_afterloginpage\priyadarshini\3.png" alt=""></a>
        </div>
        <div class="pic3">
            <a href=""><img src="female_models_afterloginpage\priyadarshini\4.png" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="female_models_afterloginpage\priyadarshini\5.png" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="female_models_afterloginpage\priyadarshini\6.png"></a>
        </div>
    </div>
</div>
 <script>
