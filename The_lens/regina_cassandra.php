...
<div class="header">
    <div class="container1">
        ...
        <div class="row">
            <div class="col">
                <img src="female_models_afterloginpage\regina cassandra\3.png" height="650px" width="500px"></div>
                <div class="col">
                <h1>
                            REGINA CASSANDRA
                </h1>
                <p>Name:Regina Cassandra<br>Email:REgina548@gmail.com<br>Age:25year old<br>Experince:REd model Management<br>Height: 123cm<br>Waist:80cm <br>Chest:75cm <br>Hips:73cm <br>Shoes:23.6<br>Hair:Darkest Brown <br>Shirt:XL<br>PH No:3544789643</p>
...
<div class="row1">
 <div class="container">
    ...
    <div class="photo-gallery">
        ...
        <div class="pic">
           <a href=""><img src="female_models_afterloginpage\regina cassandra\1.png"></a>
        </div>
        <div class="pic1">
            <a href=""><img src="female_models_afterloginpage\regina cassandra\2.png" alt=""></a>
        </div>
        <div class="pic2">
            <a href=""><img src="female_models_afterloginpage\regina cassandra\4.png" alt=""></a>
        </div>
        <div class="pic3">
            <a href=""><img src="female_models_afterloginpage\regina cassandra\3.png" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="female_models_afterloginpage\regina cassandra\5.png" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="female_models_afterloginpage\regina cassandra\6.png"></a>
        </div>
    </div>
</div>
 <script>
