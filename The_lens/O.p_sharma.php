...
<div class="header">
    <div class="container1">
        ...
        <div class="row">
            <div class="col">
                <img src="male_photographers\3.png" height="650px" width="500px"></div>
                <div class="col">
                <h1>
                            O.P SHARMA
                </h1>
                <p>Name:O.p Sharma<br>Age:35year old<br>Email:Shrama547@gmail.com<br>Experience:Candid Photography <br>Gender:Male<br> Location:Kolkata<br>Instagram</p>
...
<div class="row1">
 <div class="container">
    ...
    <div class="photo-gallery">
        ...
        <div class="pic">
           <a href=""><img src="male_photographers\O.p sharma\O.p Sharma1.jpg"></a>
        </div>
        <div class="pic1">
            <a href=""><img src="male_photographers\O.p sharma\O.p Sharma2.jpg" alt=""></a>
        </div>
        <div class="pic2">
            <a href=""><img src="male_photographers\O.p sharma\O.p Sharma3.jpg" alt=""></a>
        </div>
        <div class="pic3">
            <a href=""><img src="male_photographers\O.p sharma\O.p Sharma4.jpg" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="male_photographers\O.p sharma\O.p Sharma5.jpg" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="male_photographers\O.p sharma\O.p Sharma6.jpg"></a>
        </div>
    </div>
</div>
 <script>
