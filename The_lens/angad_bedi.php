...
<div class="header">
    <div class="container1">
        ...
        <div class="row">
            <div class="col">
                <img src="male_model_afterlogin\angad bedi\pfp.png" height="650px" width="500px"></div>
                <div class="col">
                <h1>
                            ANGAD BEDI
                </h1>
                <p>Name:Angad Bedi<br>Email:Angadbedi115@gmail.com<br>Age:27year old<br>Experince:Freelance Modeling<br>Height: 123cm<br>Waist:68cm<br>Chest:80cm<br>Hips:88cm<br>Shoes:24.2cm<br>Hair:lightest Blonde<br>Shirt:XL<br>PH No:4589763219</p>
...
<div class="row1">
 <div class="container">
    ...
    <div class="photo-gallery">
        ...
        <div class="pic">
           <a href=""><img src="male_model_afterlogin\angad bedi\1.png"></a>
        </div>
        <div class="pic1">
            <a href=""><img src="male_model_afterlogin\angad bedi\7.png" alt=""></a>
        </div>
        <div class="pic2">
            <a href=""><img src="male_model_afterlogin\angad bedi\3.png" alt=""></a>
        </div>
        <div class="pic3">
            <a href=""><img src="male_model_afterlogin\angad bedi\4.png" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="male_model_afterlogin\angad bedi\5.png" alt=""></a>
        </div>
         <div class="pic2">
            <a href=""><img src="male_model_afterlogin\angad bedi\6.png" alt=""></a>
        </div>
    </div>
</div>
 <script>
